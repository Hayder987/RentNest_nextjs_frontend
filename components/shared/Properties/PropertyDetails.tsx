    ...
    <section className="mx-auto max-w-7xl px-4 py-8 lg:py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <Card className="overflow-hidden rounded-2xl p-0">
          <Image
            ...
            width={900}
            height={700}
            className="h-75 w-full object-cover sm:h-112.5 lg:h-full"
            priority
          />
        </Card>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        <Card className="space-y-5 p-6">
          ...
          {
            userData?.success && userData?.data?.role === "TENANT" ? <Button
            className="w-full"
          ...
          >
            {property.available
              ? "Request Rental"
              : "Not Available"}
          </Button> : <p className="text-red-500">Only TENANT Can send Rental Request!</p>
          }
        </Card>
      </div>
    </section>
