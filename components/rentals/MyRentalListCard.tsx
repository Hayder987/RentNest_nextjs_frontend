import { getMyRentalRequestsAction } from '@/app/(dashboardGroup)/_actions/TenantActions/getMyRentalRequestsAction';
import { MyRentalRequest } from '@/lib/rental.type';
import RentalCard from './RentalCard';

const MyRentalListCard = async() => {
...
export default MyRentalListCard